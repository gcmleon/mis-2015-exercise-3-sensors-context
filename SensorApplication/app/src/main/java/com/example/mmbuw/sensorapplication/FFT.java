...
public class FFT {
    ...
    // Lookup tables. Only need to recompute when size of com.example.mmbuw.sensorapplication.FFT changes.
    double[] cos;
    double[] sin;
    ...
    public FFT(int n) {
        ...
        if (n != (1 << m))
            throw new RuntimeException("com.example.mmbuw.sensorapplication.FFT length must be power of 2");
     ...
     *
     *   input:
     * n: length of com.example.mmbuw.sensorapplication.FFT: must be a power of two
     * m: n = 2**m
     *   input/output
    ...
    public void fft(double[] x, double[] y) {
        ...
        // com.example.mmbuw.sensorapplication.FFT
        n1 = 0;
        n2 = 1;
